<?php /*a:3:{s:47:"D:\SwiftAdmin\app\admin\view\index\basecfg.html";i:1664341995;s:47:"D:\SwiftAdmin\app\admin\view\public\header.html";i:1664337374;s:47:"D:\SwiftAdmin\app\admin\view\public\footer.html";i:1659669829;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="layui-row">
        <div class="layui-card">
            <div class="layui-card-body">
                <form id="baseForm" action="<?php echo url('/index/baseSet'); ?>" lay-filter="baseForm" class="layui-form layui-row model-form" wid100>
                    <div class="layui-tab layui-tab-brief">
                        ...
                        <div class="layui-tab-content">
                            ...
                            <div class="layui-tab-item">
                                ...
                                <div class="cache_status" <?php if($config['cache_status'] == '0'): ?> style="display:none;" <?php endif; ?> >
                                    <div class="layui-form-item">
                            ...
                            <div class="layui-tab-item">
                                ...
                                <div class="layui-cloud-oss" <?php if($config['cloud_status'] == '0'): ?>
                                    ...
                                    <!-- 腾讯云上传 -->
                                    <div class="qcloud_oss" <?php if($config['cloud_type'] != 'qcloud_oss'): ?> style="display:none;" <?php endif; ?> >
                                        <div class="layui-form-item">
                                ...
                                <div class="layui-collapse " lay-accordion="" style="border-style: none;">
                                    ...
                                    <div class="layui-colla-item">
                                        ...
                                        <div class="layui-colla-content">
                                            ...
                                            <div class="layui-card-header" style="margin-bottom:20px;"><i class="layui-icon"><img src="/static/images/interface/qcloud.png" width="16" height="16" alt=""></i><?php echo __('腾讯SMS短信'); ?></div>
                                            <div class="layui-form-item">
                                                <label class="layui-form-label">APP_ID</label>
                                                <div class="layui-input-inline">
                                            ...
                                            <div class="layui-form-item">
                                                ...
                                                <div class="layui-form-mid layui-word-aux">* <?php echo __('您在腾讯云中API密钥的SecretId'); ?>。</div>
                                            </div>

                                            <div class="layui-form-item">
                                                <label class="layui-form-label">SECRET_KEY</label>
                                                <div class="layui-input-inline">
                                                    <input type="text" name="tensms[secret_key]" value="<?php echo htmlentities($config['tensms']['secret_key']); ?>" class="layui-input">
                                                </div>
                                                <div class="layui-form-mid layui-word-aux">
...
<!--                                </div>-->
                            ...
                            <div class="layui-tab-item">
                                ...
                                <button type="button" class="layui-btn layui-btn-normal layui-variable-add"><?php echo __('增加变量'); ?></button>
                            </div>
                            <!-- // POST按钮 -->
